...
public class MainActivity extends AppCompatActivity {
    ...
    private void chequeaLetra(String letra) {
        ...
        //chequeo si se ha terminado la partida pq ha acertado toas las letras
    ...
    private String escogePalabra() {
        String auxiliar = "";
        String[] listaPalabras = {"hola", "adios", "cono", "desconozco", "icono", "diacono", "conocida", "conocimiento", "esternocleidomastoideo"};
        Random r = new Random();
